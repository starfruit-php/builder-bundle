...
pimcore.bundle.tinymce.editor = Class.create({
    ...
    createWysiwyg: function (e) {
        ...
        const toolbar1 = 'undo redo | blocks | fontfamily | fontsize | forecolor | backcolor ' +
            'bold italic underline | alignleft aligncenter ' +
            'alignright alignjustify | link';

        const toolbar2 = 'table | media | bullist numlist outdent indent | removeformat | code | help';
        let toolbar;
        ...
        tinymce.init(Object.assign({
            ...
            font_family_formats: 'Andale Mono=andale mono,times; Arial=arial,helvetica,sans-serif; Arial Black=arial black,avant garde; Book Antiqua=book antiqua,palatino; Comic Sans MS=comic sans ms,sans-serif; Courier New=courier new,courier; Georgia=georgia,palatino; Helvetica=helvetica; Impact=impact,chicago; Inter=inter; Oswald=oswald; Symbol=symbol; Tahoma=tahoma,arial,helvetica,sans-serif; Terminal=terminal,monaco; Times New Roman=times new roman,times; Trebuchet MS=trebuchet ms,geneva; Verdana=verdana,geneva; Webdings=webdings; Wingdings=wingdings,zapf dingbats',
            ...
            suffix: '.min',
            convert_urls: false,
            extended_valid_elements: 'a[name|href|target|title|pimcore_id|pimcore_type|rel],img[style|longdesc|usemap|src|border|alt=|title|hspace|vspace|width|height|align|pimcore_id|pimcore_type]',

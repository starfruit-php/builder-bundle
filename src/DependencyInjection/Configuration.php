            ...
            ->children()
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->booleanNode('update_while_empty')
                                ...
                                ->defaultTrue()
                            ->end()
                            ->booleanNode('update_after_publish')
                                ->info('Yes or no that changing slug afer publishing')
                                ->defaultFalse()
                            ->end()
                            ->booleanNode('insert_id_to_slug')
                                ->info('Yes or no that inserting object id to last position of slug')
                                ->defaultTrue()
                            ->end()
                ...
                ->arrayNode('template')
                    ->children()
                        ->arrayNode('editmode')
                            ->children()
                                ->booleanNode('hide_default_css')
                                    ->info('Hide default css file')
                                    ->defaultFalse()
                                ->end()
                                ->arrayNode('custom_css_files')
                                    ->scalarPrototype()
                                    ->info('Custom css files')
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
